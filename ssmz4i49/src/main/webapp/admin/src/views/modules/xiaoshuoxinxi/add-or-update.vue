          ...
          <el-form-item class="input" label="价格" prop="price">
              <el-input v-model="ruleForm.price" 
                placeholder="价格" readonly></el-input>
                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="小说简介" prop="xiaoshuojianjie">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.xiaoshuojianjie" label="小说简介" prop="xiaoshuojianjie">
                    <span v-html="ruleForm.xiaoshuojianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                            ...
                                                            this.$http({
              url: `option/xiaoshuofenlei/fenlei`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
	...
	this.ruleForm.xiaoshuojianjie = this.ruleForm.xiaoshuojianjie.replace(reg,'../../../ssmz4i49/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
