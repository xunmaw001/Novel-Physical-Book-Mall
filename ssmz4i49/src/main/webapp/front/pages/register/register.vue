<template>
	<view class="content">
		...
		<view v-if="tableName=='yonghu'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"rgba(242, 199, 68, 1)","backgroundColor":"#fff","borderRadius":"32rpx","color":"#333","textAlign":"left","borderWidth":"4rpx 4rpx 4rpx 4rpx","fontSize":"24rpx","borderStyle":"solid","height":"80rpx"}' v-model="ruleForm.lianxidianhua" type="text" class="uni-input" name="" placeholder="联系电话" />
		</view>
		<view>
